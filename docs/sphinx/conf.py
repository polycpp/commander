# Sphinx configuration for the commander companion library.
#
...
html_theme_options = {
    ...
    'source_repository': 'https://github.com/polycpp/commander',
...
html_baseurl = 'https://polycpp.github.io/commander/'
